...
urlpatterns = [
    ...
    path('api/forgot-password', views.forgot_password_view, name='api_forgot_password'),
    path('reset-password', views.reset_password_view, name='reset_password'),
    path('api/reset-password', views.reset_password_view, name='api_reset_password'),
    ...
    path('api/resend-otp', views.resend_otp_view, name='api_resend_otp'),
    ...
    path('settings/master-data', views.api_master_data_save, name='save_master_data'),
    path('api/settings/master-data', views.api_master_data_save, name='api_save_master_data'),
    path('api/master-data', views.api_master_data_get, name='api_master_data_get'),
